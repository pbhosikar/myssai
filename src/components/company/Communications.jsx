...
const CommunicationsAnnouncement = () => (
  <div className="mb-6">
    <p className="text-base text-gray-700 mb-4 font-sans max-w-5xl">
      Welcome to SSAI's Communications Department. We want to work with you to build strong
    ...
    <div className="mt-6 text-center">
      <h2 className="text-blue-600 text-xl sm:text-2xl font-extrabold leading-snug">
        Discover more! Watch all of our latest Podcast videos on YouTube for exclusive content,
        tips, and behind-the-scenes insights. Click below to join our community!
      </h2>
    </div>
  </div>
);
...
const CarouselBlock = ({ slides, variableHeight }) => {
  ...
  return (
    <div
      ...
      style={{
        height: variableHeight ? slideHeight : COMM_CAROUSEL_HEIGHT,
...
const MeetTeamSidebar = () => (
  <div>
    ...
    <div className="space-y-5">
      {[
        {
          img: '/company/communications/DawnAlexander.jpg',
          name: 'Dawn Alexander',
          role: 'Marketing and Communications Director',
          phone: '201-798-1303',
          email: 'dawn.alexander@ssaihq.com',
        },
        {
          img: '/company/communications/json.jpg',
          name: 'Jason Dietrich',
          role: 'Communications Specialist',
          phone: '301-867-3230',
          email: 'jason.dietrich@ssaihq.com',
        },
        {
          img: '/company/communications/eunice.jpeg',
          name: 'Eunice Kim',
          role: 'Communications Specialist',
          phone: '',
          email: 'eunice.kim@ssaihq.com',
        },
        {
          img: '/company/communications/sanjana.jpg',
          name: 'Sanjana Kottapalli',
          role: 'Communications Intern',
          phone: '',
          email: 'sanjana.kottapalli@ssaihq.com',
        },
      ].map((t, idx) => (
...
const SidebarRight = () => (
  <div className="w-full flex flex-col items-start mt-2 space-y-0 font-sans">
    ...
    <div className="flex flex-col gap-3 mb-2">
      <a
        href="https://ssaihq.account.box.com/login?redirect_url=https%3A%2F%2Fssaihq.app.box.com%2Fs%2Fxlvl91l8jjy6u4b2bqekari6o3f3r4eu"
        className="text-[#2d5cf6] font-semibold text-sm hover:underline"
      >
        Network Status
      </a>
      <a
        ...
        className="text-[#2d5cf6] font-semibold text-sm hover:underline"
      >
        Communication Resources & Best Practices for SSAI Employees
      </a>
      <a
        href="https://ssaihq.account.box.com/login?redirect_url=https%3A%2F%2Fssaihq.app.box.com%2Fs%2Fxlvl91l8jjy6u4b2bqekari6o3f3r4eu"
        className="text-[#2d5cf6] font-semibold text-sm hover:underline"
    ...
    <div className="text-base text-gray-800 mb-5 mt-2">
      If you have trouble accessing any of these Box documents, please email IT Support at{' '}
      <a href="mailto:it_help@ssaihq.com" className="text-[#1246ea] hover:underline">
        it_help@ssaihq.com
      </a>
      .
    </div>
    <div className="mt-6 mb-1 text-start w-full">
      <h3 className="text-[#3356a1] font-bold text-xl mb-2">
        Contact us with your questions or inquiries
      </h3>
      <p className="!text-xl !font-light text-gray-700 !mb-5">
        We're here to help! Send your questions, comments, concerns, or ideas to{' '}
        <a href="mailto:connect@ssaihq.com" className="text-[#1246ea] !font-light hover:underline">
          connect@ssaihq.com
        </a>
        .
      </p>
      <p className="!text-xl !font-light text-gray-700 mt-1">
        Together, we can continue to make SSAI a success!
      </p>
    </div>
  </div>
);
  ...
  <section className="min-h-screen bg-white">
    <div className="w-full relative h-52 flex items-center bg-white">
      ...
      <div className="absolute left-8 top-8 md:left-36 md:top-14 z-10">
        <h1 className="text-white text-xl md:!text-2xl font-bold mb-5 drop-shadow-lg">
          Communications
        </h1>
