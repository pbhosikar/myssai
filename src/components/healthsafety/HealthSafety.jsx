      ...
      <section className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-[#b95000] overflow-hidden mb-8">
            <div className="bg-[#b95000] text-white p-4">
              <h2 className="text-xl font-bold">
                Report all Accidents and Hazards immediately to:
              </h2>
            </div>
            <div className="p-6">
              <ol className="list-decimal list-inside space-y-2 text-sm text-gray-800 mb-4">
                <li>Your SSAI Manager</li>
                <li>SSAI & Customer Safety Representative, if appropriate*</li>
              </ol>
              <p className="text-xs text-gray-700 mb-4 leading-relaxed">
                *Call your SSAI Manager first. SSAI's Managers help staff to ensure that we adhere
                to all applicable government, contract, and company requirements for safety
                practices, procedures, and reporting.
              </p>
              <p className="text-xs text-gray-700 leading-relaxed">
                If you cannot reach your manager or if there is an imminent threat at your facility,
                contact an SSAI Safety Representative or other contact for your Region/Facility.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-700 mb-1">10210 Greenbelt Road, Suite 600</p>
            <p className="text-sm text-gray-700 mb-6">Lanham, MD 20706</p>
              ...
              <div className="mt-4 space-y-3">
                <div>
                  <h5 className="text-sm font-bold text-gray-900">
                    SSAI Lanham Office (Aerospace)
                  </h5>
                  <p className="text-sm text-gray-700">Josie Pearson (757) 951-1607</p>
                  <p className="text-sm text-gray-700">SSAI Building Emergency Plan - Lanham</p>
                </div>
              </div>
            </div>
          </div>
