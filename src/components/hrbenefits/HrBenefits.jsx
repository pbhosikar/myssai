  ...
  const benefitsCards = [
    {
      ...
      alt: 'Cigna',
      title: 'Medical/Rx',
      details: ['Cigna | Group # 3344665', '800-997-1654'],
    ...
    },
    {
      ...
      alt: 'MetLife',
      title: 'Dental',
      details: ['MetLife | Group # 135398', '800-275-4638'],
    ...
    },
    {
      ...
      alt: 'VSP Vision Care',
      title: 'Vision',
      details: ['VSP | Group # 12169354', '800-877-7195'],
    ...
    },
    {
      ...
      details: ['Lincoln Financial Group', '855-891-3684', 'Web ID: LifeKeys'],
    ...
    },
    {
      ...
      details: ['Lincoln Financial', '800-423-2765'],
    ...
    },
    {
      ...
      details: ['BHS', '800-237-2251', 'Web ID: SSAI'],
    ...
    },
    {
      ...
      alt: 'BHS',
      title: 'Employee Assistance Program (EAP)',
      details: ['BHS', '888-628-4824', 'Username: LFGsupport | Password:LFGsupport1'],
      link: 'http://www.guidanceresources.com/',
      linkText: 'http://www.guidanceresources.com/',
    },
    {
      ...
      details: ['Lincoln Financial Group', '866-525-1955', 'Group ID: LFGTravel123'],
    ...
    },
    {
      ...
      details: ['MetLife | Group # 135398', '800-438-6388'],
    ...
    },
    {
      ...
      alt: 'Nationwide',
      title: 'Pet Insurance',
      details: ['Nationwide', '977-738-7874'],
    ...
    },
    {
      ...
      details: ['Legal Resources', '800-728-5768'],
    ...
    },
    {
      ...
      details: ['Farmers Insurance', '800-438-6381'],
      ...
      <section className="min-h-screen bg-gray-50">
        ...
        >
          <div className="absolute top-4 left-4 sm:left-32 sm:top-12">
            <h1 className="text-white text-xl sm:text-2xl font-bold drop-shadow-lg">HR-Benefits</h1>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="mb-8">
            <p className="text-sm text-black leading-relaxed">
              We are committed to fostering a workplace where every employee has the opportunity to
              succeed based on their contributions, talent, and dedication. We believe that a
              strong, respectful, and united team - made up of individuals from all walks of life -
              help drive innovation and excellence. Our employee programs and benefits reflect this
              belief, supporting your health, professional growth, and financial well-being. We
              offer comprehensive healthcare, strong retirement plans, wellness initiatives, and
              career development opportunities — all designed to create an environment where every
              team member feels respected, empowered, and set up for success.
            </p>
          </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <p className="text-xs text-gray-700 leading-relaxed mb-3">
                  Kathleen Jackson is SSAI's Health Advocate Support from NFP. She is your trusted
                  partner in navigating the complexities of healthcare. Managing your health and
                  wellness can feel overwhelming and that's we have Kathleen — to support you every
                  step of the way.
                </p>
                <p className="text-xs text-gray-700 leading-relaxed mb-4">
                  Whether you're facing a medical issue, or need assistance understanding your
                  benefits, Kathleen is here to listen, guide, and advocate on your behalf. You can
                  have peace of mind knowing that expert support is just a call or click away. Your
                  health is our priority, and we're here to help you thrive.
                </p>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <ul className="space-y-3">
                  <li>
                    <a
                      href="https://ssaihq.app.box.com/file/1506319417295"
                      target="_blank"
                  ...
                  <li>
                    <a
                      href="https://ssaihq.account.box.com/login?redirect_url=%2Ffile%2F1506319390895"
                      target="_blank"
                      className="text-xs text-blue-600 hover:underline"
                    >
                  ...
                  <li>
                    <a
                      href="https://ssaihq.account.box.com/login?redirect_url=%2Ffile%2F1506319414895"
                      target="_blank"
                      className="text-xs text-blue-600 hover:underline"
                    >
                  ...
                  <li>
                    <a
                      href="https://ssaihq.account.box.com/login?redirect_url=%2Ffile%2F1506319400495"
                      target="_blank"
                      className="text-xs text-blue-600 hover:underline"
                    >
                  ...
                  <li>
                    <a
                      href="https://ssaihq.account.box.com/login?redirect_url=%2Ffile%2F1506284855248"
                      target="_blank"
                      className="text-xs text-blue-600 hover:underline"
                    >
                  ...
                  <li>
                    <a
                      href="https://workforcenow.adp.com/public/index.htm"
                      target="_blank"
                      className="text-xs text-blue-600 hover:underline"
                    >
