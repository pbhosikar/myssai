          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
                <p className="text-sm text-gray-700 leading-relaxed mb-4">
                  At SSAI, our talented employees are our greatest resource. Our goal is to create a
                  culture of learning and prepare our employees to meet the changing workforce needs
                  of both today and tomorrow.
                </p>
                <p className="text-sm text-gray-700 leading-relaxed mb-4">
                  Investing in our employees’ success is at the center of our organization’s
                  strategic goals. This led to the creation of Science Systems and Applications,
                  Inc. University (SSAIU), which serves as the centralized strategic umbrella for
                  the education and development of our workforce. SSAIU is the link between
                  developing employees and building leadership teams that will continue to meet the
                  organization’s strategic goals, now and into the future.
                </p>
                <p className="text-sm text-gray-700 leading-relaxed">
                  Comprised of three centers, SSAIU provides unique learning opportunities and ways
                  for employees to grow and diversify their skills. SSAIU's three centers focus on
                  developing employees’ professional, leadership, and specialized technical
                  abilities through offerings such as a robust learning portal, customized
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-5">
                      ...
                      <p className="text-sm text-gray-600">Grow and Diversify</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-5">
                      ...
                      <p className="text-sm text-gray-600">Invest in Our People and Our Brand</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-5">
                      ...
                      <p className="text-sm text-gray-600">Optimize Creativity and Productivity</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-700 mb-1">Phone: 757-951-1607</p>
                    <a
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="mb-6">
                  <h4 className="text-sm font-bold text-gray-900 mb-2">Education Reimbursement</h4>
                  <p className="text-xs text-gray-700 leading-relaxed">
                    Application for Educational Assistance must be submitted for approval within two
                    weeks prior to beginning the(se) course(s). Approval will not be granted without
                    a recommendation by the employee’s supervisor.
                  </p>
                </div>

                {/* Training Requests */}
                <div className="mb-6">
                  <h4 className="text-sm font-bold text-gray-900 mb-2">Training Requests</h4>
                  <p className="text-xs text-gray-700 leading-relaxed mb-3">
                    Application for Training must be submitted for approval prior to the beginning
                    of the training. Approval will not be granted without the approval of the
                    employee’s Program Manager.
                  </p>
                  <a
                    href="https://ssaihq.app.box.com/file/1506333433849"
                    target="_blank"
                    className="text-xs text-blue-600 hover:underline"
                  >
                    To learn more HRM-003{' '}
                  </a>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed mb-2">
                    SSAI reimburses employees for subscribing to professional publications or
                    membership in professional societies. To learn more, email us at
                  </p>
                  <a
