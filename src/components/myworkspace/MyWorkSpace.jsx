...
import { getAllEvents, createEvent, getEventById } from '../../services/eventService.js';
...
export default function MyWorkSpace() {
    ...
    try {
      ...
      const formatDate = (date) => {
        return date.toLocaleDateString('en-US', { 
          ...
          month: 'long', 
          day: 'numeric',
          hour: eventDetails.allDay ? undefined : '2-digit',
          minute: eventDetails.allDay ? undefined : '2-digit'
        });
      };

      Swal.fire({
        title: `<strong>${eventDetails.title}</strong>`,
        html: `
          <div style="text-align: left; padding: 10px;">
            ...
            ${eventDetails.allDay ? '<p style="margin: 10px 0;"><strong>All Day Event</strong></p>' : ''}
            ${eventDetails.repeat ? '<p style="margin: 10px 0;"><strong>Repeating Event</strong></p>' : ''}
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      // POST to JSON Server using service
...
<style jsx global>{`
    /* FullCalendar date numbers - make them black */
    ...
    /* Day names (Sun, Mon, Tue, etc.) - make them black */
    .fc-col-header-cell-cushion {
      color: #000000 !important;
      font-weight: 500;
    }
    ...
    /* All FullCalendar buttons - blue background with white text */
    .fc-button {
    ...
    /* Active state for month/week/day buttons */
    .fc-button-active {
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-4">
                  <div className="flex items-center gap-3 mb-4">
                    <button 
                      className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium transition-colors cursor-pointer"
                ...
                >
                  ...
                  <div className="flex items-center justify-between px-12 py-6 border-b border-gray-200 flex-shrink-0">
                    ...
                    <button
                      type="button"
                      onClick={handleCloseModal}
                      className="text-gray-400 hover:text-gray-600 text-3xl font-light leading-none cursor-pointer"
                    >
                      ×
                    </button>
                  </div>
                  ...
                  <div className="flex items-center gap-3 px-12 py-6 border-t border-gray-200 flex-shrink-0">
                    <button
                      ...
                      className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
...
//         /* Month/Week/Day buttons and navigation - make them black */
//         .fc-button,
//         .fc-toolbar-title {
//           color: #000000 !important;
//         }
